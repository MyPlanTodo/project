...
{Première connexion}
    ...
    {\begin{itemize}
        ...
        social;
        \item[7.] L'utilisateur entre ses identifiants et choisi de laisser
	...
	{\begin{itemize}
        ...
        des identifiants vide à SoftCard qui les relaie à FaceCrypt qui fait
        de même pour l'extension;
        \item[6.] L'extension recevant des identifiants vide ouvre une popup
