...
\begin{description}
    ...
    \item[Utilisateur :] entité (humain ou programme) intéragissant ce 
        sous-projet;
    ...
    \item[Aléatoire :] indistinguable en temps polynomial, distribution
...
La communication sécurisé est une précondition pour tous les prochains cas 
...
{Déblocage de la carte par code PUK}
	...
	{\begin{itemize}
        \item[]
		\item[2.] SoftCard indique que le code PIN est verrouillée et que la 
...
{Transmission login/mot de passe au SocialNetwork}
    ...
    {L'utilisateur veut se loguer sur SocialNetwork}
    {L'utilisateur est logué auprès de SocialNetwork.}
    {\begin{itemize}
        \item[]
