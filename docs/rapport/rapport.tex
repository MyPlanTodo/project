...
\paragraph{}
Comme dit précédemment, l'implémentation de l'API Java Card sur les cartes fournies n'était pas complète, certaines fonctions étant optionnelles dans la 
