...
public class client_echo {
	...
	public static byte[] APPLET_AID= { (byte)0x01, (byte)0x02, (byte)0x03, (byte)0x04, (byte)0x05, (byte)0x06, (byte)0x07, (byte)0x08, (byte)0x09, (byte)0x00, (byte)0x12 };
	...
	public static void main(String[] args) throws IOException {
		...
		try {
			...
			//r = channel.transmit(new CommandAPDU((byte)0x00, (byte)0xA4, (byte)0x04, (byte)0x00));
			if (r.getSW() != 0x9000) {
			...
			*/
			    ...
			    byte[] test = ArrayTools.RandomArray((short) 64);	
				while(compteur  < 500)
			    {	
				
				//int choix = 10;
				//System.out.println("Valeur du compteur : "+choix);
					r = channel.transmit(new CommandAPDU((byte)0xB0, 0x00, (byte) choix, (byte)0x00, test));
