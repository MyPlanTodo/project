...
public class Test_SessionKey {
	/* Constantes */
	public static final byte CLA_MONAPPLET = (byte) 0xB0;

	private static final short IV_LENGTH = 16;
	private static final short AES_BLOCK_LENGTH = 16;
	private  final static SecretKey aesKey2 = new SecretKeySpec(new byte[]{10,1,1,5,9,6,5,4,5,9,6,6,6,9,2,6}, "AES");
			     ...
			     int  choix = 1;
			       ...
			       case 1:
				       ...
				       r = channel.transmit(new CommandAPDU((byte)0xB0, 0x02, 0, 0));
				        ...
				        cipher2.init(Cipher.DECRYPT_MODE, aesKey2, new IvParameterSpec(iv2));					
				        byte[] data2;
